            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl border-2 border-gray-200 hover:shadow-xl transition">
                <div class="p-8 text-gray-900">
                    <form method="POST" action="{{ route('users.update', $user) }}" class="space-y-6">
                        ...
                        <!-- Daerah -->
                        <div class="border-2 border-yellow-200 rounded-lg p-5 bg-gradient-to-br from-yellow-50 to-pink-50">
                        ...
                        <div class="flex items-center justify-end gap-3 pt-6 border-t-2 border-gray-200">
                            ...
                            <button type="submit"
                                class="inline-flex items-center gap-2 px-7 py-2.5 bg-gradient-to-r from-yellow-600 to-pink-600 text-white rounded-lg hover:shadow-lg transition font-bold text-sm">
