                ...
                <div class="p-6">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gradient-to-r from-violet-50 to-purple-50 border-b-2 border-gray-200">
                                <tr>
                                ...
                                @forelse($kelurahans as $index => $kelurahan)
                                    <tr class="hover:bg-violet-50 transition">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2 flex items-center">
                                            <a href="{{ route('kelurahan.edit', $kelurahan) }}" class="inline-flex items-center px-3 py-1.5 bg-yellow-100 text-yellow-700 rounded-lg hover:bg-yellow-200 transition font-bold">✏️ Edit</a>
