                    ...
                    <form method="POST" action="{{ route('kelurahan.update', $kelurahan) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                required 
                                autofocus
                                class="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:border-primary-600 focus:ring-2 focus:ring-primary-200 outline-none transition" 
                            />
                            @error('nama')
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-200">
                            ...
                            <button type="submit" class="inline-flex items-center px-6 py-2.5 bg-gradient-to-r from-primary-600 to-primary-600 text-white rounded-lg hover:shadow-lg font-bold transition">
                                💾 Simpan
                            </button>
                        </div>
                    </form>
