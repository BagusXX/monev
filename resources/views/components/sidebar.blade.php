<div x-data="{ open: false, collapsed: false, isMobile: window.innerWidth < 1024 }"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto flex flex-col">
        ...
        <nav class="space-y-1 flex-1 overflow-y-auto scrollbar-hide">
            ...
            <!-- Kegiatan Section (NEW - WORKFLOW: Plan → Realize → Report) -->
            <div class="pt-6 mt-6 border-t border-gray-200">
                ...
                <!-- Rencana Kegiatan -->
                <x-sidebar-link :href="route('rencana.index')" :active="request()->routeIs('rencana.*')" class="group relative">
                    <span class="flex-shrink-0 w-6 h-6 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 transition-transform group-hover:scale-110">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M11.35 3.836c-.633.283-1.346.377-2.023.377a3.75 3.75 0 0 0-5.23 3.528l3.773-2.215A.75.75 0 0 0 7.75 3a2.25 2.25 0 0 1 2.25 2.25c0 .584-.233 1.112-.603 1.5H20.25A3.75 3.75 0 0 0 16.5 1.5a48.972 48.972 0 0 0-8.15 2.336ZM14.25 8.75v6.528a2.25 2.25 0 0 1-1.5 2.122m5.175-1.1a.75.75 0 0 0 .75.75H20.25a.75.75 0 0 0 .75-.75M15 15.75v-6.75" />
                        </svg>
                    </span>
                    <span x-show="!collapsed" class="hidden lg:inline font-medium">📝 Rencana Kegiatan</span>
                    <span x-show="collapsed && isMobile" class="absolute left-full ml-2 px-2 py-1 bg-gray-900 text-white text-xs rounded-md whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50 hidden md:inline-block">Rencana Kegiatan</span>
                </x-sidebar-link>
                ...
                <x-sidebar-link :href="route('monitoring.kegiatan')" :active="request()->routeIs('monitoring.kegiatan*')" class="group relative">
                    ...
                    <span x-show="!collapsed" class="hidden lg:inline font-medium">🚀 Realisasi Kegiatan</span>
                    <span x-show="collapsed && isMobile" class="absolute left-full ml-2 px-2 py-1 bg-gray-900 text-white text-xs rounded-md whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50 hidden md:inline-block">Realisasi Kegiatan</span>
                </x-sidebar-link>
            </div>
