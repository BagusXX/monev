<div x-data="{ open: false, collapsed: false }"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto flex flex-col">
        ...
        <div class="mb-6 px-4 py-4 border-b border-gray-200 flex items-center" :class="{ 'justify-center': collapsed, 'justify-between': !collapsed }">
            ...
            <a x-show="!collapsed" href="{{ route('home') }}" class="flex items-center">
                <x-application-logo class="block h-9 w-auto fill-current text-primary-600" />
                <span class="ml-3 text-xl font-bold text-gray-900 hidden lg:inline">{{ config('app.name', 'Laravel') }}</span>
            </a>
            
            <!-- Collapse button (shown when expanded) -->
            <button x-show="!collapsed" @click="$dispatch('sidebar-collapse')" class="hidden lg:block p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors" title="Collapse sidebar">
            ...
            <button x-show="collapsed" @click="$dispatch('sidebar-collapse')" class="hidden lg:flex items-center justify-center w-full p-2 text-gray-500 hover:text-primary-\ hover:bg-primary-50 rounded-lg transition-colors" title="Expand sidebar">
        ...
        <nav class="space-y-2">
            <x-sidebar-link x-ref="firstLink" :href="route('home')" :active="request()->routeIs('home')">
                ...
                <span x-show="!collapsed" class="hidden lg:inline">Home</span>
            </x-sidebar-link>
            ...
            <x-sidebar-link :href="route('setup')" :active="request()->routeIs('setup')">
                ...
                <span x-show="!collapsed" class="hidden lg:inline">User Management</span>
            </x-sidebar-link>
            ...
            <x-sidebar-link :href="route('monitor')" :active="request()->routeIs('monitor')">
                ...
                <span x-show="!collapsed" class="hidden lg:inline">Monitoring Rapat</span>
            </x-sidebar-link>
            ...
            <x-sidebar-link :href="route('monitoring.kegiatan')" :active="request()->routeIs('monitoring.kegiatan*')">
                ...
                <span x-show="!collapsed" class="hidden lg:inline">Monitoring Kegiatan</span>
            </x-sidebar-link>

            <!-- Daerah Section -->
            <div class="pt-4">
                <div class="px-4 mb-2">
                    <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider" x-show="!collapsed">
                        Daerah
                    </h3>
                </div>
                
                <x-sidebar-link :href="route('daerah.index')" :active="request()->routeIs('daerah.*')">
                    <span class="flex-shrink-0 w-6 h-6 mr-3 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <span x-show="!collapsed" class="hidden lg:inline">Manajemen Daerah</span>
                </x-sidebar-link>
            </div>
            ...
            <div class="pt-4">
                ...
                <x-sidebar-link :href="route('laporan.rapat')" :active="request()->routeIs('laporan.rapat*')">
                    ...
                    <span x-show="!collapsed" class="hidden lg:inline">Laporan Rapat</span>
                </x-sidebar-link>
                ...
                <x-sidebar-link :href="route('laporan.kegiatan')" :active="request()->routeIs('laporan.kegiatan*')">
                    ...
                    <span x-show="!collapsed" class="hidden lg:inline">Laporan Kegiatan</span>
                </x-sidebar-link>
            </div>
