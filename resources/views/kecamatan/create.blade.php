    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Tambahkan kecamatan baru ke dalam sistem</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl border-2 border-gray-200">
                <div class="bg-gradient-to-r from-green-600 to-emerald-600 p-6">
                    <h3 class="font-bold text-lg text-white">📋 Form Input Kecamatan</h3>
                </div>

                <div class="p-8">
                    <form method="POST" action="{{ route('kecamatan.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-200">
                            ...
                            <button type="submit" class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:shadow-lg transition font-bold">
                                ✅ Simpan Kecamatan
                            </button>
                        </div>
                    </form>
